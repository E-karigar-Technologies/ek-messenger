...
import { GlobalSettingsSyncService } from './global-settings-sync.service';
...
export class ThemeService {
  ...
  constructor(private globalSettingsSync: GlobalSettingsSyncService) { }
  ...
  save(theme: ChatTheme) {
    try {
      ...
      this.globalSettingsSync.saveSection('chatTheme', t);
 ...
 */
  ...
  randomTheme(): ChatTheme {
    ...
    // Apply device theme immediately
